 ...
 * PriorityList class
 *
 * PriorityList implements a priority ordered list collection class.  It allows you to specify
 ...
 * PriorityList can also be used like a regular array as follows,
 * <code>
 ...
 * </code>
 *
 * To extend PriorityList for doing your own operations with each addition or removal,
 * override {@link insertAtIndexInPriority()} and {@link removeAtIndexInPriority()} and then call the parent.
 *
 * @author Anthonius Munthi <me@itstoni.com>
 */
class PriorityList extends ListCollection
{
	/**
	...
	public function insertAt($index,$item)
	{
		...
		if(($priority=$this->priorityAt($index,true))!==false){
			...
			throw new InvalidDataValueException('list_index_invalid',$index);//@codeCoverageIgnore
        }
	}
	...
	{
		if($data instanceof PriorityList)
		{
			if($this->getCount()>0)
				$this->clear();
	 ...
	 * New data will be appended to the end of the existing data.  If another PriorityList is merged,
