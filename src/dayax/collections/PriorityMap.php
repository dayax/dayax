...
class PriorityMap extends Map
{
	 ...
	 * @param map|array|Iterator|PriorityMap the intial data. Default is null, meaning no initialization.
	...
	{
		if($data instanceof PriorityMap)
		{
			if($this->getCount()>0)
				$this->clear();
